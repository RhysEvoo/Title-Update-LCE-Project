...
void PreStitchedTextureMap::loadUVs()
{
	if(!texturesByName.empty())
	{
		...
		// GameRenderer::runUpdate thread rhysevo
	...
	float slotX = 1.0f/16.0f;
	float slotY = 1.0f/17.0f;
	if(iconType != Icon::TYPE_TERRAIN)
	{

		texturesByName.insert(stringIconMap::value_type(L"prismarine_shard",new SimpleIcon(L"prismarine_shard",slotX*13,slotY*13,slotX*(13+1),slotY*(13+1))));
		texturesByName.insert(stringIconMap::value_type(L"prismarine_crystals",new SimpleIcon(L"prismarine_crystals",slotX*14,slotY*13,slotX*(14+1),slotY*(13+1))));
		texturesByName.insert(stringIconMap::value_type(L"banner",new SimpleIcon(L"banner",slotX*2,slotY*15,slotX*(2+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"end_crystal",new SimpleIcon(L"end_crystal",slotX*6,slotY*2,slotX*(6+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"elytra",new SimpleIcon(L"elytra", slotX*15, slotY*0, slotX*(15+1), slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"chorus_fruit",new SimpleIcon(L"chorus_fruit",slotX*15,slotY*2,slotX*(15+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"chorus_fruit_popped",new SimpleIcon(L"chorus_fruit_popped",slotX*15,slotY*3,slotX*(15+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"beetroot_seeds",new SimpleIcon(L"beetroot_seeds",slotX*2,slotY*12,slotX*(2+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"beetroot",new SimpleIcon(L"beetroot",slotX*1,slotY*12,slotX*(1+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"helmetCloth",new SimpleIcon(L"helmetCloth",slotX*0,slotY*0,slotX*(0+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"helmetChain",new SimpleIcon(L"helmetChain",slotX*1,slotY*0,slotX*(1+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"helmetIron",new SimpleIcon(L"helmetIron",slotX*2,slotY*0,slotX*(2+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"helmetDiamond",new SimpleIcon(L"helmetDiamond",slotX*3,slotY*0,slotX*(3+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"helmetGold",new SimpleIcon(L"helmetGold",slotX*4,slotY*0,slotX*(4+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"flintAndSteel",new SimpleIcon(L"flintAndSteel",slotX*5,slotY*0,slotX*(5+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"flint",new SimpleIcon(L"flint",slotX*6,slotY*0,slotX*(6+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"coal",new SimpleIcon(L"coal",slotX*7,slotY*0,slotX*(7+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"string",new SimpleIcon(L"string",slotX*8,slotY*0,slotX*(8+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"seeds",new SimpleIcon(L"seeds",slotX*9,slotY*0,slotX*(9+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"apple",new SimpleIcon(L"apple",slotX*10,slotY*0,slotX*(10+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"appleGold",new SimpleIcon(L"appleGold",slotX*11,slotY*0,slotX*(11+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"egg",new SimpleIcon(L"egg",slotX*12,slotY*0,slotX*(12+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"sugar",new SimpleIcon(L"sugar",slotX*13,slotY*0,slotX*(13+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"snowball",new SimpleIcon(L"snowball",slotX*14,slotY*0,slotX*(14+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"slot_empty_helmet",new SimpleIcon(L"slot_empty_helmet",slotX*15,slotY*0,slotX*(15+1),slotY*(0+1))));
		texturesByName.insert(stringIconMap::value_type(L"chestplateCloth",new SimpleIcon(L"chestplateCloth",slotX*0,slotY*1,slotX*(0+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"chestplateChain",new SimpleIcon(L"chestplateChain",slotX*1,slotY*1,slotX*(1+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"chestplateIron",new SimpleIcon(L"chestplateIron",slotX*2,slotY*1,slotX*(2+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"chestplateDiamond",new SimpleIcon(L"chestplateDiamond",slotX*3,slotY*1,slotX*(3+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"chestplateGold",new SimpleIcon(L"chestplateGold",slotX*4,slotY*1,slotX*(4+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"bow",new SimpleIcon(L"bow",slotX*5,slotY*1,slotX*(5+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"brick",new SimpleIcon(L"brick",slotX*6,slotY*1,slotX*(6+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"ingotIron",new SimpleIcon(L"ingotIron",slotX*7,slotY*1,slotX*(7+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"feather",new SimpleIcon(L"feather",slotX*8,slotY*1,slotX*(8+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"wheat",new SimpleIcon(L"wheat",slotX*9,slotY*1,slotX*(9+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"painting",new SimpleIcon(L"painting",slotX*10,slotY*1,slotX*(10+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"reeds",new SimpleIcon(L"reeds",slotX*11,slotY*1,slotX*(11+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"bone",new SimpleIcon(L"bone",slotX*12,slotY*1,slotX*(12+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"cake",new SimpleIcon(L"cake",slotX*13,slotY*1,slotX*(13+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"slimeball",new SimpleIcon(L"slimeball",slotX*14,slotY*1,slotX*(14+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"slot_empty_chestplate",new SimpleIcon(L"slot_empty_chestplate",slotX*15,slotY*1,slotX*(15+1),slotY*(1+1))));
		texturesByName.insert(stringIconMap::value_type(L"leggingsCloth",new SimpleIcon(L"leggingsCloth",slotX*0,slotY*2,slotX*(0+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"leggingsChain",new SimpleIcon(L"leggingsChain",slotX*1,slotY*2,slotX*(1+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"leggingsIron",new SimpleIcon(L"leggingsIron",slotX*2,slotY*2,slotX*(2+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"leggingsDiamond",new SimpleIcon(L"leggingsDiamond",slotX*3,slotY*2,slotX*(3+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"leggingsGold",new SimpleIcon(L"leggingsGold",slotX*4,slotY*2,slotX*(4+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"arrow",new SimpleIcon(L"arrow",slotX*5,slotY*2,slotX*(5+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"quiver",new SimpleIcon(L"quiver",slotX*6,slotY*2,slotX*(6+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"ingotGold",new SimpleIcon(L"ingotGold",slotX*7,slotY*2,slotX*(7+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"sulphur",new SimpleIcon(L"sulphur",slotX*8,slotY*2,slotX*(8+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"bread",new SimpleIcon(L"bread",slotX*9,slotY*2,slotX*(9+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"sign",new SimpleIcon(L"sign",slotX*10,slotY*2,slotX*(10+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"doorWood",new SimpleIcon(L"doorWood",slotX*11,slotY*2,slotX*(11+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"doorIron",new SimpleIcon(L"doorIron",slotX*12,slotY*2,slotX*(12+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"bed",new SimpleIcon(L"bed",slotX*13,slotY*2,slotX*(13+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"fireball",new SimpleIcon(L"fireball",slotX*14,slotY*2,slotX*(14+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"slot_empty_leggings",new SimpleIcon(L"slot_empty_leggings",slotX*15,slotY*2,slotX*(15+1),slotY*(2+1))));
		texturesByName.insert(stringIconMap::value_type(L"bootsCloth",new SimpleIcon(L"bootsCloth",slotX*0,slotY*3,slotX*(0+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"bootsChain",new SimpleIcon(L"bootsChain",slotX*1,slotY*3,slotX*(1+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"bootsIron",new SimpleIcon(L"bootsIron",slotX*2,slotY*3,slotX*(2+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"bootsDiamond",new SimpleIcon(L"bootsDiamond",slotX*3,slotY*3,slotX*(3+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"bootsGold",new SimpleIcon(L"bootsGold",slotX*4,slotY*3,slotX*(4+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"stick",new SimpleIcon(L"stick",slotX*5,slotY*3,slotX*(5+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"compass",new SimpleIcon(L"compass",slotX*6,slotY*3,slotX*(6+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"compassP0",new SimpleIcon(L"compassP0",slotX*7,slotY*14,slotX*(7+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"compassP1",new SimpleIcon(L"compassP1",slotX*8,slotY*14,slotX*(8+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"compassP2",new SimpleIcon(L"compassP2",slotX*9,slotY*14,slotX*(9+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"compassP3",new SimpleIcon(L"compassP3",slotX*10,slotY*14,slotX*(10+1),slotY*(14+1))));
		...
		texturesByName.insert(stringIconMap::value_type(L"diamond",new SimpleIcon(L"diamond",slotX*7,slotY*3,slotX*(7+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"redstone",new SimpleIcon(L"redstone",slotX*8,slotY*3,slotX*(8+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"clay",new SimpleIcon(L"clay",slotX*9,slotY*3,slotX*(9+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"paper",new SimpleIcon(L"paper",slotX*10,slotY*3,slotX*(10+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"book",new SimpleIcon(L"book",slotX*11,slotY*3,slotX*(11+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"map",new SimpleIcon(L"map",slotX*12,slotY*3,slotX*(12+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"seeds_pumpkin",new SimpleIcon(L"seeds_pumpkin",slotX*13,slotY*3,slotX*(13+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"seeds_melon",new SimpleIcon(L"seeds_melon",slotX*14,slotY*3,slotX*(14+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"slot_empty_boots",new SimpleIcon(L"slot_empty_boots",slotX*15,slotY*3,slotX*(15+1),slotY*(3+1))));
		texturesByName.insert(stringIconMap::value_type(L"swordWood",new SimpleIcon(L"swordWood",slotX*0,slotY*4,slotX*(0+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"swordStone",new SimpleIcon(L"swordStone",slotX*1,slotY*4,slotX*(1+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"swordIron",new SimpleIcon(L"swordIron",slotX*2,slotY*4,slotX*(2+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"swordDiamond",new SimpleIcon(L"swordDiamond",slotX*3,slotY*4,slotX*(3+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"swordGold",new SimpleIcon(L"swordGold",slotX*4,slotY*4,slotX*(4+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"fishingRod",new SimpleIcon(L"fishingRod",slotX*5,slotY*4,slotX*(5+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"clock",new SimpleIcon(L"clock",slotX*6,slotY*4,slotX*(6+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"clockP0",new SimpleIcon(L"clockP0",slotX*11,slotY*14,slotX*(11+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"clockP1",new SimpleIcon(L"clockP1",slotX*12,slotY*14,slotX*(12+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"clockP2",new SimpleIcon(L"clockP2",slotX*13,slotY*14,slotX*(13+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"clockP3",new SimpleIcon(L"clockP3",slotX*14,slotY*14,slotX*(14+1),slotY*(14+1))));
		...
		texturesByName.insert(stringIconMap::value_type(L"bowl",new SimpleIcon(L"bowl",slotX*7,slotY*4,slotX*(7+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"mushroomStew",new SimpleIcon(L"mushroomStew",slotX*8,slotY*4,slotX*(8+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"yellowDust",new SimpleIcon(L"yellowDust",slotX*9,slotY*4,slotX*(9+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"bucket",new SimpleIcon(L"bucket",slotX*10,slotY*4,slotX*(10+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"bucketWater",new SimpleIcon(L"bucketWater",slotX*11,slotY*4,slotX*(11+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"bucketLava",new SimpleIcon(L"bucketLava",slotX*12,slotY*4,slotX*(12+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"milk",new SimpleIcon(L"milk",slotX*13,slotY*4,slotX*(13+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_black",new SimpleIcon(L"dyePowder_black",slotX*14,slotY*4,slotX*(14+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_gray",new SimpleIcon(L"dyePowder_gray",slotX*15,slotY*4,slotX*(15+1),slotY*(4+1))));
		texturesByName.insert(stringIconMap::value_type(L"shovelWood",new SimpleIcon(L"shovelWood",slotX*0,slotY*5,slotX*(0+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"shovelStone",new SimpleIcon(L"shovelStone",slotX*1,slotY*5,slotX*(1+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"shovelIron",new SimpleIcon(L"shovelIron",slotX*2,slotY*5,slotX*(2+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"shovelDiamond",new SimpleIcon(L"shovelDiamond",slotX*3,slotY*5,slotX*(3+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"shovelGold",new SimpleIcon(L"shovelGold",slotX*4,slotY*5,slotX*(4+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"fishingRod_empty",new SimpleIcon(L"fishingRod_empty",slotX*5,slotY*5,slotX*(5+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"diode",new SimpleIcon(L"diode",slotX*6,slotY*5,slotX*(6+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"porkchopRaw",new SimpleIcon(L"porkchopRaw",slotX*7,slotY*5,slotX*(7+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"porkchopCooked",new SimpleIcon(L"porkchopCooked",slotX*8,slotY*5,slotX*(8+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"fishRaw",new SimpleIcon(L"fishRaw",slotX*9,slotY*5,slotX*(9+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"fishCooked",new SimpleIcon(L"fishCooked",slotX*10,slotY*5,slotX*(10+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"rottenFlesh",new SimpleIcon(L"rottenFlesh",slotX*11,slotY*5,slotX*(11+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"cookie",new SimpleIcon(L"cookie",slotX*12,slotY*5,slotX*(12+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"shears",new SimpleIcon(L"shears",slotX*13,slotY*5,slotX*(13+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_red",new SimpleIcon(L"dyePowder_red",slotX*14,slotY*5,slotX*(14+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_pink",new SimpleIcon(L"dyePowder_pink",slotX*15,slotY*5,slotX*(15+1),slotY*(5+1))));
		texturesByName.insert(stringIconMap::value_type(L"pickaxeWood",new SimpleIcon(L"pickaxeWood",slotX*0,slotY*6,slotX*(0+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"pickaxeStone",new SimpleIcon(L"pickaxeStone",slotX*1,slotY*6,slotX*(1+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"pickaxeIron",new SimpleIcon(L"pickaxeIron",slotX*2,slotY*6,slotX*(2+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"pickaxeDiamond",new SimpleIcon(L"pickaxeDiamond",slotX*3,slotY*6,slotX*(3+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"pickaxeGold",new SimpleIcon(L"pickaxeGold",slotX*4,slotY*6,slotX*(4+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"bow_pull_0",new SimpleIcon(L"bow_pull_0",slotX*5,slotY*6,slotX*(5+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"carrotOnAStick",new SimpleIcon(L"carrotOnAStick",slotX*6,slotY*6,slotX*(6+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"leather",new SimpleIcon(L"leather",slotX*7,slotY*6,slotX*(7+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"saddle",new SimpleIcon(L"saddle",slotX*8,slotY*6,slotX*(8+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"beefRaw",new SimpleIcon(L"beefRaw",slotX*9,slotY*6,slotX*(9+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"beefCooked",new SimpleIcon(L"beefCooked",slotX*10,slotY*6,slotX*(10+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"enderPearl",new SimpleIcon(L"enderPearl",slotX*11,slotY*6,slotX*(11+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"blazeRod",new SimpleIcon(L"blazeRod",slotX*12,slotY*6,slotX*(12+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"melon",new SimpleIcon(L"melon",slotX*13,slotY*6,slotX*(13+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_green",new SimpleIcon(L"dyePowder_green",slotX*14,slotY*6,slotX*(14+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_lime",new SimpleIcon(L"dyePowder_lime",slotX*15,slotY*6,slotX*(15+1),slotY*(6+1))));
		texturesByName.insert(stringIconMap::value_type(L"hatchetWood",new SimpleIcon(L"hatchetWood",slotX*0,slotY*7,slotX*(0+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"hatchetStone",new SimpleIcon(L"hatchetStone",slotX*1,slotY*7,slotX*(1+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"hatchetIron",new SimpleIcon(L"hatchetIron",slotX*2,slotY*7,slotX*(2+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"hatchetDiamond",new SimpleIcon(L"hatchetDiamond",slotX*3,slotY*7,slotX*(3+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"hatchetGold",new SimpleIcon(L"hatchetGold",slotX*4,slotY*7,slotX*(4+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"bow_pull_1",new SimpleIcon(L"bow_pull_1",slotX*5,slotY*7,slotX*(5+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"potatoBaked",new SimpleIcon(L"potatoBaked",slotX*6,slotY*7,slotX*(6+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"potato",new SimpleIcon(L"potato",slotX*7,slotY*7,slotX*(7+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"carrots",new SimpleIcon(L"carrots",slotX*8,slotY*7,slotX*(8+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"chickenRaw",new SimpleIcon(L"chickenRaw",slotX*9,slotY*7,slotX*(9+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"chickenCooked",new SimpleIcon(L"chickenCooked",slotX*10,slotY*7,slotX*(10+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"ghastTear",new SimpleIcon(L"ghastTear",slotX*11,slotY*7,slotX*(11+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"goldNugget",new SimpleIcon(L"goldNugget",slotX*12,slotY*7,slotX*(12+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"netherStalkSeeds",new SimpleIcon(L"netherStalkSeeds",slotX*13,slotY*7,slotX*(13+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_brown",new SimpleIcon(L"dyePowder_brown",slotX*14,slotY*7,slotX*(14+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_yellow",new SimpleIcon(L"dyePowder_yellow",slotX*15,slotY*7,slotX*(15+1),slotY*(7+1))));
		texturesByName.insert(stringIconMap::value_type(L"hoeWood",new SimpleIcon(L"hoeWood",slotX*0,slotY*8,slotX*(0+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"hoeStone",new SimpleIcon(L"hoeStone",slotX*1,slotY*8,slotX*(1+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"hoeIron",new SimpleIcon(L"hoeIron",slotX*2,slotY*8,slotX*(2+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"hoeDiamond",new SimpleIcon(L"hoeDiamond",slotX*3,slotY*8,slotX*(3+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"hoeGold",new SimpleIcon(L"hoeGold",slotX*4,slotY*8,slotX*(4+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"bow_pull_2",new SimpleIcon(L"bow_pull_2",slotX*5,slotY*8,slotX*(5+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"potatoPoisonous",new SimpleIcon(L"potatoPoisonous",slotX*6,slotY*8,slotX*(6+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"minecart",new SimpleIcon(L"minecart",slotX*7,slotY*8,slotX*(7+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"boat",new SimpleIcon(L"boat",slotX*8,slotY*8,slotX*(8+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"speckledMelon",new SimpleIcon(L"speckledMelon",slotX*9,slotY*8,slotX*(9+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"fermentedSpiderEye",new SimpleIcon(L"fermentedSpiderEye",slotX*10,slotY*8,slotX*(10+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"spiderEye",new SimpleIcon(L"spiderEye",slotX*11,slotY*8,slotX*(11+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"potion",new SimpleIcon(L"potion",slotX*12,slotY*8,slotX*(12+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"glassBottle",new SimpleIcon(L"glassBottle",slotX*12,slotY*8,slotX*(12+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"potion_contents",new SimpleIcon(L"potion_contents",slotX*13,slotY*8,slotX*(13+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_blue",new SimpleIcon(L"dyePowder_blue",slotX*14,slotY*8,slotX*(14+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_lightBlue",new SimpleIcon(L"dyePowder_lightBlue",slotX*15,slotY*8,slotX*(15+1),slotY*(8+1))));
		texturesByName.insert(stringIconMap::value_type(L"helmetCloth_overlay",new SimpleIcon(L"helmetCloth_overlay",slotX*0,slotY*9,slotX*(0+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"comparator",new SimpleIcon(L"comparator",slotX*5,slotY*9,slotX*(5+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"carrotGolden",new SimpleIcon(L"carrotGolden",slotX*6,slotY*9,slotX*(6+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"minecartChest",new SimpleIcon(L"minecartChest",slotX*7,slotY*9,slotX*(7+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"pumpkinPie",new SimpleIcon(L"pumpkinPie",slotX*8,slotY*9,slotX*(8+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"monsterPlacer",new SimpleIcon(L"monsterPlacer",slotX*9,slotY*9,slotX*(9+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"potion_splash",new SimpleIcon(L"potion_splash",slotX*10,slotY*9,slotX*(10+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"eyeOfEnder",new SimpleIcon(L"eyeOfEnder",slotX*11,slotY*9,slotX*(11+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"cauldron",new SimpleIcon(L"cauldron",slotX*12,slotY*9,slotX*(12+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"blazePowder",new SimpleIcon(L"blazePowder",slotX*13,slotY*9,slotX*(13+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_purple",new SimpleIcon(L"dyePowder_purple",slotX*14,slotY*9,slotX*(14+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_magenta",new SimpleIcon(L"dyePowder_magenta",slotX*15,slotY*9,slotX*(15+1),slotY*(9+1))));
		texturesByName.insert(stringIconMap::value_type(L"chestplateCloth_overlay",new SimpleIcon(L"chestplateCloth_overlay",slotX*0,slotY*10,slotX*(0+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"netherbrick",new SimpleIcon(L"netherbrick",slotX*5,slotY*10,slotX*(5+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"minecartFurnace",new SimpleIcon(L"minecartFurnace",slotX*7,slotY*10,slotX*(7+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"monsterPlacer_overlay",new SimpleIcon(L"monsterPlacer_overlay",slotX*9,slotY*10,slotX*(9+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"ruby",new SimpleIcon(L"ruby",slotX*10,slotY*10,slotX*(10+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"expBottle",new SimpleIcon(L"expBottle",slotX*11,slotY*10,slotX*(11+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"brewingStand",new SimpleIcon(L"brewingStand",slotX*12,slotY*10,slotX*(12+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"magmaCream",new SimpleIcon(L"magmaCream",slotX*13,slotY*10,slotX*(13+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_cyan",new SimpleIcon(L"dyePowder_cyan",slotX*14,slotY*10,slotX*(14+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_orange",new SimpleIcon(L"dyePowder_orange",slotX*15,slotY*10,slotX*(15+1),slotY*(10+1))));
		texturesByName.insert(stringIconMap::value_type(L"leggingsCloth_overlay",new SimpleIcon(L"leggingsCloth_overlay",slotX*0,slotY*11,slotX*(0+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"minecartHopper",new SimpleIcon(L"minecartHopper",slotX*7,slotY*11,slotX*(7+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"hopper",new SimpleIcon(L"hopper",slotX*8,slotY*11,slotX*(8+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"netherStar",new SimpleIcon(L"netherStar",slotX*9,slotY*11,slotX*(9+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"emerald",new SimpleIcon(L"emerald",slotX*10,slotY*11,slotX*(10+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"writingBook",new SimpleIcon(L"writingBook",slotX*11,slotY*11,slotX*(11+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"writtenBook",new SimpleIcon(L"writtenBook",slotX*12,slotY*11,slotX*(12+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"flowerPot",new SimpleIcon(L"flowerPot",slotX*13,slotY*11,slotX*(13+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_silver",new SimpleIcon(L"dyePowder_silver",slotX*14,slotY*11,slotX*(14+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"dyePowder_white",new SimpleIcon(L"dyePowder_white",slotX*15,slotY*11,slotX*(15+1),slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"bootsCloth_overlay",new SimpleIcon(L"bootsCloth_overlay",slotX*0,slotY*12,slotX*(0+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"minecartTnt",new SimpleIcon(L"minecartTnt",slotX*7,slotY*12,slotX*(7+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"fireworks",new SimpleIcon(L"fireworks",slotX*9,slotY*12,slotX*(9+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"fireworksCharge",new SimpleIcon(L"fireworksCharge",slotX*10,slotY*12,slotX*(10+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"fireworksCharge_overlay",new SimpleIcon(L"fireworksCharge_overlay",slotX*11,slotY*12,slotX*(11+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"netherquartz",new SimpleIcon(L"netherquartz",slotX*12,slotY*12,slotX*(12+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"emptyMap",new SimpleIcon(L"emptyMap",slotX*13,slotY*12,slotX*(13+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"frame",new SimpleIcon(L"frame",slotX*14,slotY*12,slotX*(14+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"enchantedBook",new SimpleIcon(L"enchantedBook",slotX*15,slotY*12,slotX*(15+1),slotY*(12+1))));
		texturesByName.insert(stringIconMap::value_type(L"skull_skeleton",new SimpleIcon(L"skull_skeleton",slotX*0,slotY*14,slotX*(0+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"skull_wither",new SimpleIcon(L"skull_wither",slotX*1,slotY*14,slotX*(1+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"skull_zombie",new SimpleIcon(L"skull_zombie",slotX*2,slotY*14,slotX*(2+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"skull_char",new SimpleIcon(L"skull_char",slotX*3,slotY*14,slotX*(3+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"skull_creeper",new SimpleIcon(L"skull_creeper",slotX*4,slotY*14,slotX*(4+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"dragonFireball",new SimpleIcon(L"dragonFireball",slotX*15,slotY*14,slotX*(15+1),slotY*(14+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_13",new SimpleIcon(L"record_13",slotX*0,slotY*15,slotX*(0+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_cat",new SimpleIcon(L"record_cat",slotX*1,slotY*15,slotX*(1+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_blocks",new SimpleIcon(L"record_blocks",slotX*2,slotY*15,slotX*(2+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_chirp",new SimpleIcon(L"record_chirp",slotX*3,slotY*15,slotX*(3+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_far",new SimpleIcon(L"record_far",slotX*4,slotY*15,slotX*(4+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_mall",new SimpleIcon(L"record_mall",slotX*5,slotY*15,slotX*(5+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_mellohi",new SimpleIcon(L"record_mellohi",slotX*6,slotY*15,slotX*(6+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_stal",new SimpleIcon(L"record_stal",slotX*7,slotY*15,slotX*(7+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_strad",new SimpleIcon(L"record_strad",slotX*8,slotY*15,slotX*(8+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_ward",new SimpleIcon(L"record_ward",slotX*9,slotY*15,slotX*(9+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_11",new SimpleIcon(L"record_11",slotX*10,slotY*15,slotX*(10+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"record_where are we now",new SimpleIcon(L"record_where are we now",slotX*11,slotY*15,slotX*(11+1),slotY*(15+1))));
		texturesByName.insert(stringIconMap::value_type(L"muttonRaw",new SimpleIcon(L"muttonRaw", slotX*4, slotY*11, slotX*(4+1), slotY*(11+1))));
		texturesByName.insert(stringIconMap::value_type(L"muttonCooked",new SimpleIcon(L"muttonCooked", slotX*4, slotY*12, slotX*(4+1), slotY*(12+1))));
