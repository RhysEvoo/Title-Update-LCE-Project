...
public:
	...
	//rhysevoo update static

	static Item *prismarineShard;
	static Item *prismarineCrystals;
	static Item *banner;
	static Item *endCrystal;
	static Item *elytra;
	static Item *chorusFruit;
	static Item *chorusFruitPopped;
	static Item *beetrootSeeds;
	static Item *beetroot;
	static Item *muttonRaw;
	static Item *muttonCooked;
	...
	static const int prismarineShard_Id		 = 407;
	static const int prismarineCrystals_Id	 = 408;
	static const int banner_Id			 = 409;
	static const int endCrystal_Id		 = 410;
	static const int elytra_Id			 = 411;
	static const int chorusFruit_Id		 = 412;
	static const int chorusFruitPopped_Id	 = 413;
	static const int beetrootSeeds_Id		 = 414;
	static const int beetroot_Id			 = 415;
	static const int muttonRaw_Id			 = 416;
	static const int muttonCooked_Id			 = 417;
public:
	const int id;
