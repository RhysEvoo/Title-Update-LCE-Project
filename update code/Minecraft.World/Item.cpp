...
Item *Item::muttonRaw = NULL;
Item *Item::muttonCooked = NULL;
...
void Item::staticCtor()
{
	...
	Item::prismarineShard		= ( new Item(151) )														->setTextureName(L"prismarine_shard")->setDescriptionId(IDS_ITEM_PRISMARINE_SHARD);
	Item::prismarineCrystals	= ( new Item(152) )														->setTextureName(L"prismarine_crystals")->setDescriptionId(IDS_ITEM_PRISMARINE_CRYSTALS);
	Item::banner				= ( new Item(153) )														->setTextureName(L"banner")->setDescriptionId(IDS_ITEM_BANNER);
	Item::endCrystal			= ( new Item(154) )														->setTextureName(L"end_crystal")->setDescriptionId(IDS_ITEM_END_CRYSTAL);
	Item::elytra				= ( new Item(155) )														->setTextureName(L"elytra")->setDescriptionId(IDS_ITEM_ELYTRA);

	Item::chorusFruit			= ( new FoodItem(156, 4, FoodConstants::FOOD_SATURATION_NORMAL, false) )	->setTextureName(L"chorus_fruit")->setDescriptionId(IDS_ITEM_CHORUS_FRUIT);
	Item::chorusFruitPopped		= ( new Item(157) )														->setTextureName(L"chorus_fruit_popped")->setDescriptionId(IDS_ITEM_CHORUS_FRUIT_POPPED);

	//Item::beetrootSeeds			= ( new SeedItem(158, Tile::beetroots_Id, Tile::farmland_Id) )			->setTextureName(L"beetroot_seeds")->setDescriptionId(IDS_ITEM_BEETROOT_SEEDS);
	Item::beetroot				= ( new FoodItem(159, 1, FoodConstants::FOOD_SATURATION_LOW, false) )	->setTextureName(L"beetroot")->setDescriptionId(IDS_ITEM_BEETROOT);

	Item::muttonRaw = (new FoodItem(160, 2, FoodConstants::FOOD_SATURATION_LOW, true))
    ->setTextureName(L"muttonRaw")
    ->setDescriptionId(IDS_ITEM_MUTTON_RAW)
    ->setUseDescriptionId(IDS_DESC_MUTTON_RAW);
	
	Item::muttonCooked = (new FoodItem(161, 6, FoodConstants::FOOD_SATURATION_NORMAL, true))
    ->setTextureName(L"muttonCooked")
...
const int Item::prismarineShard_Id		;
const int Item::prismarineCrystals_Id	;
const int Item::banner_Id			;
const int Item::endCrystal_Id		;
const int Item::elytra_Id			;
const int Item::chorusFruit_Id		;
const int Item::chorusFruitPopped_Id	;
const int Item::beetrootSeeds_Id		;
